...
module Functor =
  Preface_laws_pbt.Functor.Cases (Preface_stdlib.Seq.Functor) (Req)
    (Preface_qcheck.Sample.Pack1)

module Applicative =
  Preface_laws_pbt.Applicative.Cases (Preface_stdlib.Seq.Applicative) (Req)
    (Preface_qcheck.Sample.Pack1)

module Selective =
  Preface_laws_pbt.Selective.Rigid_cases (Preface_stdlib.Seq.Selective) (Req)
    (Preface_qcheck.Sample.Pack1)

module Alternative =
  Preface_laws_pbt.Alternative.Cases (Preface_stdlib.Seq.Alternative) (Req)
    (Preface_qcheck.Sample.Pack1)

module Monad =
  Preface_laws_pbt.Monad.Cases (Preface_stdlib.Seq.Monad) (Req)
    (Preface_qcheck.Sample.Pack1)
